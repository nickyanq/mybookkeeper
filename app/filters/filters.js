/**
 * Filter to parse date to dd/mm H:i
 */
app.filter('timeParse', function() {
	return function(input) {
		...
		ret += day + '/' + month + '  ' + hours + ':' + minutes;
		return ret;
	};
});

/**
 * Filter for spliting input from a given string, and an split index.
 */
...
app.filter('currencyType', function() {
	return function(input) {
		switch (input) {
			case 'RON' :
				{
